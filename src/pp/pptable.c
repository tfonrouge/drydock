...
static HB_PP_TOKEN s_dr079[ 1 ] = {
   { NULL       , NULL       , "2104281802",        10, 0, 0xc02a, 0 }
};
...
static HB_PP_TOKEN s_dr081[ 1 ] = {
   { NULL       , NULL       , "4643587824552fd877e7f02ad11596e0b30c465d",  40, 0, 0xc029, 0 }
};
static HB_PP_TOKEN s_dm082[ 1 ] = {
   { NULL       , NULL       , "HB_VER_LENTRY",     13, 0, 0xc015, 0 }
};
static HB_PP_TOKEN s_dr082[ 1 ] = {
   { NULL       , NULL       , "2021-04-28 20:02 UTC+0200 Aleksander Czajczynski (hb fki.pl)",  60, 0, 0xc029, 0 }
};
